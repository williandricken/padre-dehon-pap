...
class ResponsiblesControllerTest < ActionController::TestCase
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post :create, responsible: { cpf: @responsible.cpf, name: @responsible.name, rg: @responsible.rg, schooling: @responsible.schooling }
    end
  ...
  test "should update responsible" do
    patch :update, id: @responsible, responsible: { cpf: @responsible.cpf, name: @responsible.name, rg: @responsible.rg, schooling: @responsible.schooling }
    assert_redirected_to responsible_path(assigns(:responsible))
  end
